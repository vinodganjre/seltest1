package com.seltest1.utilities;

//lister class to generate Report
...
public class Reporting extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext) 
	{
		...
		String repName = "Test-Report-"+timeStamp+".html"; //name of the Report which is in HTML
		...
		htmlReporter.config().setDocumentTitle("Sel Test Project"); //Title of the project
